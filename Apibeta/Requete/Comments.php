 ...
 * @author TetzPHP
 */
abstract class Comments extends Requete
{
    ...
    public static function postComment($type, $id, $text, $in_reply_to = null)
    {
        ...
        return new Commentaire(array_merge(static::executer(__METHOD__, $parametres), array('depuis_type' => $type)));
    }
    ...
    public static function deleteComment($id)
    {
        $parametres = array();
        $parametres['id'] = $id;
        return new Commentaire(static::executer(__METHOD__, $parametres));
    }
    ...
    public static function getComments($type, $id, $nbpp, $since_id = null, $order = Comments::ORDER_ASC)
    {
        ...
        return Commentaire::tableau(static::executer(__METHOD__, $parametres), array('depuis_type' => $type));
    }
